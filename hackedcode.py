...
sigma = 40.0  # Standard deviation on the Gaussian envelope
# (remember Heisenberg uncertainty).
...
# For non-zero potentials,  plot them and shade the classically forbidden
# region in light red,  as well as drawing a green line at the wavepacket's
# total energy,  in the same units the potential is being plotted.
if Vmax != 0:
...
for t in range(T+1):  # Precompute a couple of indexing constants, this speeds up the computation
    psi_rPR = psi_r[PR]
    psi_iPR = psi_i[PR]
